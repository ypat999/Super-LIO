...
def generate_launch_description():
    ...
    try:
        ...
        from global_config import (
            ...
            NAV2_DEFAULT_PARAMS_FILE, LIVOX_MID360_CONFIG
        )
    ...
    imu_to_livox_frame_tf = Node(
        ...
        executable='static_transform_publisher',
        parameters=[{'use_sim_time': DEFAULT_USE_SIM_TIME}],
        arguments=['0.0', '0', '0.0', deg_to_rad(0), deg_to_rad(0), deg_to_rad(0), 'imu', 'x500_depth_0/livox_down_frame/mid360_down_lidar'],
        output='screen'
    )
    ...
    livox_frame_to_base_link_tf = Node(
        ...
        arguments=['-0.1', '0', '-0.2', deg_to_rad(0), deg_to_rad(210), '0', 'x500_depth_0/livox_down_frame/mid360_lidar', 'x500_depth_0/base_link'],
        output='screen'
    )
